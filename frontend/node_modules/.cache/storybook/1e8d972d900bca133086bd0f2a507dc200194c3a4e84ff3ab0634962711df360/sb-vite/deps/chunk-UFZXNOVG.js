import {
  ...
  spread_props,
  wrap_snippet
} from "./chunk-6IMGZ2NU.js";
import {
  append,
  comment,
  mount,
  unmount
} from "./chunk-UVLAURRJ.js";
import {
  FILENAME,
  HMR,
  HYDRATION_END,
  ...
  push,
  set
} from "./chunk-B2DZ2PBP.js";
import {
  VERSION
} from "./chunk-IRBXMYFO.js";
import {
  __export
      ...
      if (null != t) {
        ...
        try {
          if (i = (t = t.call(r)).next, 0 === l3) {
            ...
            f2 = false;
          } else for (; !(f2 = (e2 = i.call(t)).done) && (a2.push(e2.value), a2.length !== l3); f2 = true) ;
        } catch (r2) {
          o2 = true, n2 = r2;
        } finally {
          try {
      ...
      if (null != t) {
        ...
        try {
          if (i2 = (t = t.call(r)).next, 0 === l3) {
            if (Object(t) !== t) return;
            f2 = false;
          } else for (; !(f2 = (e2 = i2.call(t)).done) && (a2.push(e2.value), a2.length !== l3); f2 = true) ;
        } catch (r2) {
          o2 = true, n2 = r2;
        } finally {
          try {
    ...
    (function(global, factory) {
      ...
      function _encodeOriginalScopes(scopes, index, writer, state) {
        ...
        for (index++; index < scopes.length; ) {
          ...
          const { 0: l3, 1: c3 } = next;
          if (l3 > endLine || l3 === endLine && c3 >= endColumn) {
            break;
          }
  ...
  return function(s2) {
    ...
    var z = function(t) {
      ...
      return A2.getTokenFromCodeInType = function(e4) {
        ...
        return this.keywords.test(t2) ? e4 = l3[t2] : new RegExp(j).test(t2) && (e4 = _[t2]), this.finishToken(e4, t2);
        ...
        for (var e4 = this, s4 = t2.modified, i3 = t2.allowedModifiers, r2 = t2.disallowedModifiers, a2 = t2.stopOnStartOfClassStaticBlock, n4 = t2.errorTemplate, o2 = void 0 === n4 ? b.InvalidModifierOnTypeMember : n4, h3 = {}, p3 = function(t3, i4, r3, a3) {
          ...
          var l4 = this.startLoc, u3 = this.tsParseModifier(i3.concat(null != r2 ? r2 : []), a2);
          if (!u3) break;
          O(u3) ? s4.accessibility ? this.raise(this.start, b.DuplicateAccessibilityModifier()) : (p3(l4, u3, u3, "override"), p3(l4, u3, u3, "static"), p3(l4, u3, u3, "readonly"), p3(l4, u3, u3, "accessor"), h3.accessibility = u3, s4.accessibility = u3) : N(u3) ? s4[u3] ? this.raise(this.start, b.DuplicateModifier({ modifier: u3 })) : (p3(l4, u3, "in", "out"), h3[u3] = u3, s4[u3] = true) : I(u3) ? s4[u3] ? this.raise(this.start, b.DuplicateModifier({ modifier: u3 })) : (c3(l4, u3, "accessor", "readonly"), c3(l4, u3, "accessor", "static"), c3(l4, u3, "accessor", "override"), h3[u3] = u3, s4[u3] = true) : Object.hasOwnProperty.call(s4, u3) ? this.raise(this.start, b.DuplicateModifier({ modifier: u3 })) : (p3(l4, u3, "static", "readonly"), p3(l4, u3, "static", "override"), p3(l4, u3, "override", "readonly"), p3(l4, u3, "abstract", "override"), c3(l4, u3, "declare", "override"), c3(l4, u3, "static", "abstract"), h3[u3] = u3, s4[u3] = true), null != r2 && r2.includes(u3) && this.raise(this.start, o2);
        }
        return h3;
        ...
        var i3, r2 = this.options.ecmaVersion, a2 = this.startNode(), n4 = "", o2 = false, h3 = false, c3 = "method", l4 = ["declare", "private", "public", "protected", "accessor", "override", "abstract", "readonly", "static"], u3 = this.tsParseModifiers({ modified: a2, allowedModifiers: l4, disallowedModifiers: ["in", "out"], stopOnStartOfClassStaticBlock: true, errorTemplate: b.InvalidModifierOnTypeParameterPositions });
        ...
        var d3 = function() {
          ...
          if (s4.next(), s4.next(), s4.tsHasSomeModifiers(a2, l4) && s4.raise(s4.start, b.StaticBlockCannotHaveModifier), r2 >= 13) return t.prototype.parseClassStaticBlock.call(s4, a2), a2;
        };
        ...
        if (s4 && (c3 = s4.call(this, c3, o2, h3)), this.type.isAssign) {
          var l4 = this.startNodeAt(o2, h3);
          return l4.operator = this.value, this.type === p2.eq && (c3 = this.toAssignable(c3, true, e4)), i3 || (e4.parenthesizedAssign = e4.trailingComma = e4.doubleProto = -1), e4.shorthandAssign >= c3.start && (e4.shorthandAssign = -1), this.type === p2.eq ? this.checkLValPattern(c3) : this.checkLValSimple(c3), l4.left = c3, this.next(), l4.right = this.parseMaybeAssign(t2), n4 > -1 && (e4.doubleProto = n4), this.finishNode(l4, "AssignmentExpression");
        }
        ...
        var i3, r2, a2, o2, h3, p3, c3, l4, u3, d3, m3, f2 = this;
        if (this.matchJsx("jsxTagStart") || this.tsMatchLeftRelational()) {
          if (l4 = this.cloneCurLookaheadState(), !(u3 = this.tryParse(function() {
            return f2.parseMaybeAssignOrigin(t2, e4, s4);
          }, l4)).error) return u3.node;
        ...
        l4 && !this.compareLookaheadState(l4, this.getCurLookaheadState()) || (l4 = this.cloneCurLookaheadState());
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          var o2, h3 = this.start, c3 = this.startLoc, l4 = [], u3 = true, d3 = false, m3 = new T(), f2 = this.yieldPos, y3 = this.awaitPos;
          for (this.yieldPos = 0, this.awaitPos = 0; this.type !== p2.parenR; ) {
            ...
            if (this.type === p2.ellipsis) {
              o2 = this.start, l4.push(this.parseParenItem(this.parseRestBinding())), this.type === p2.comma && this.raise(this.start, "Comma is not permitted after the rest element");
              break;
            }
            l4.push(this.parseMaybeAssign(e4, m3, this.parseParenItem));
          }
          var x2 = this.lastTokEnd, v2 = this.lastTokEndLoc;
          if (this.expect(p2.parenR), this.maybeInArrowParameters = n4, t2 && this.shouldParseArrow(l4) && this.eat(p2.arrow)) return this.checkPatternErrors(m3, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = f2, this.awaitPos = y3, this.parseParenArrowList(i3, r2, l4, e4);
          l4.length && !d3 || this.unexpected(this.lastTokStart), o2 && this.unexpected(o2), this.checkExpressionErrors(m3, true), this.yieldPos = f2 || this.yieldPos, this.awaitPos = y3 || this.awaitPos, l4.length > 1 ? ((s4 = this.startNodeAt(h3, c3)).expressions = l4, this.finishNodeAt(s4, "SequenceExpression", x2, v2)) : s4 = l4[0];
        ...
        if (this.match(p2.questionDot) && 60 === this.lookaheadCharCode()) {
          if (i3) return t2;
          t2.optional = true, h3 = l4 = true, this.next();
        }
        if (this.tsMatchLeftRelational() || this.match(p2.bitShift)) {
          var u3, d3 = this.tsTryParseAndCatch(function() {
            ...
            if (!a3) return t2;
            if (l4 && !o2.match(p2.parenL)) return u3 = o2.curPosition(), t2;
            ...
            if (!i3 && o2.eat(p2.parenL)) {
              ...
              return m4.callee = t2, m4.arguments = o2.parseExprList(p2.parenR, o2.options.ecmaVersion >= 8, false, d4), o2.tsCheckForInvalidTypeCasts(m4.arguments), m4.typeParameters = a3, h3 && (m4.optional = l4), o2.checkExpressionErrors(d4, true), t2 = o2.finishNode(m4, "CallExpression");
            }
            var f3 = o2.type;
        ...
        if (this.isContextual("as")) {
          var l4 = this.parseIdent();
          if (this.isContextual("as")) {
            var u3 = this.parseIdent();
            U(this.type) ? (h3 = true, o2 = l4, r2 = s4 ? this.parseIdent() : this.parseModuleExportName(), p3 = false) : (r2 = u3, p3 = false);
          } else U(this.type) ? (p3 = false, r2 = s4 ? this.parseIdent() : this.parseModuleExportName()) : (h3 = true, o2 = l4);
...
function c2(content, node) {
  return node.loc ? [
    l2(node.loc.start.line, node.loc.start.column),
    content,
    l2(node.loc.end.line, node.loc.end.column)
  ] : content;
}
...
var shared = {
  ...
  "BlockStatement|ClassBody": (node, state) => {
    if (node.loc) {
      ...
      state.commands.push(l2(line, column), "{", l2(line, column + 1));
    } else {
      state.commands.push("{");
    }
    ...
    if (node.loc) {
      ...
      state.commands.push(l2(line, column - 1), "}", l2(line, column));
    } else {
      state.commands.push("}");
    }
  },
...
//# sourceMappingURL=chunk-UFZXNOVG.js.map
