import {
  require_jsx_runtime
} from "./chunk-F5WHYMXO.js";
import {
  require_react_dom
} from "./chunk-TPDNXZWA.js";
import {
  H,
  Tr,
  be,
  ...
  sr,
  yo
} from "./chunk-AZZ2YHKQ.js";
import {
  require_react
} from "./chunk-3CPOBJ5L.js";
import {
  O
...
`)
        ...
        if (B === 0) {
          ...
          if (T) {
            ...
            var N = [P], G = g7(N, $, E.properties.className);
            h.push(G);
          }
        } else {
          var z = [M], K = g7(z, $, E.properties.className);
          h.push(K);
        }
      }), f = v;
    }
...
function Ss(e, t) {
  return a(function(n) {
    ...
    } : d, f = n.useInlineStyles, v = f === void 0 ? true : f, b = n.showLineNumbers, m = b === void 0 ? false : b, g7 = n.showInlineLineNumbers, y = g7 === void 0 ? true : g7, w = n.startingLineNumber, D = w === void 0 ? 1 : w, x = n.lineNumberContainerStyle, C = n.lineNumberStyle, E = C === void 0 ? {} : C, S = n.wrapLines, R = n.wrapLongLines, A = R === void 0 ? false : R, k = n.lineProps, B = k === void 0 ? {} : k, $ = n.renderer, M = n.PreTag, W = M === void 0 ? "pre" : M, L = n.CodeTag, T = L === void 0 ? "code" : L, P = n.code, U = P === void 0 ? (Array.isArray(i) ? i[0] : i) || "" : P, N = n.astGenerator, G = wp(n, E6);
    N = N || e;
    ...
    if (A ? h.style = mt(mt({}, h.style), {}, {
      ...
      return import_react2.default.createElement(W, ve, z, import_react2.default.createElement(T, h, U));
    (S === void 0 && $ || A) && (S = true), $ = $ || T6;
    var de = [{
      type: "text",
      value: U
    }], xe = I6({
    ...
    return import_react2.default.createElement(W, ve, import_react2.default.createElement(T, h, !y && z, $({
      rows: Ie,
      stylesheet: u,
      useInlineStyles: v
    })));
  ...
  function j6(e) {
    ...
    for (c in o)
      p = new N6(
        ...
        o[c],
        t
      ), r.indexOf(c) !== -1 && (p.mustUseProperty = true), l[c] = p, u[ad(c)] = c, u[ad(p.attribute)] = c;
    return new O6(l, u, t);
  }
  a(j6, "create");
});
...
var Td = _((Ps) => {
  ...
  var _s = ",", Ld = " ", na = "";
  function E7(e) {
    for (var t = [], r = String(e || na), n = r.indexOf(_s), o = 0, i = false, l; !i; )
...
var $d = _((h$, Hd) => {
  ...
  function k7(e, t, r) {
    ...
    function i(l, u, c) {
      var p, d, h;
      c == null || c !== c || (p = R7(e, u), d = p.property, h = c, typeof h == "string" && (p.spaceSeparated ? h = Bd(h) : p.commaSeparated ? h = Md(h) : p.commaOrSpaceSeparated && (h = Bd(Md(h).join(" ")))), d === "style" && typeof c != "string" && (h = B7(h)), d === "className" && l.className && (h = l.className.concat(h)), l[d] = I7(p, d, h));
    }
  }
  a(k7, "factory");
  function L7(e, t) {
...
var mf = _((L$, hf) => {
  ...
  a(sw, "parseEntities");
  function uw(e, t) {
    var r = t.additional, n = t.nonTerminated, o = t.text, i = t.reference, l = t.warning, u = t.textContext, c = t.referenceContext, p = t.warningContext, d = t.position, h = t.indent || [], f = e.length, v = 0, b = -1, m = d.column || 1, g7 = d.line || 1, y = "", w = [], D, x, C, E, S, R, A, k, B, $, M, W, L, T, P, U, N, G, z;
    for (typeof r == "string" && (r = r.charCodeAt(0)), U = K(), k = l ? Le : Z7, v--, f++; ++v < f; )
      if (S === of && (m = h[b] || 1), S = e.charCodeAt(v), S === af) {
        ...
        for (L = v + 1, W = L, z = L, A === ow ? (z = ++W, A = e.charCodeAt(z), A === aw || A === iw ? (T = zs, z = ++W) : T = Os) : T = hn, D = "", M = "", E = "", P = hi[T], z--; ++z < f && (A = e.charCodeAt(z), !!P(A)); )
          E += fn(A), T === hn && K7.call(tf, E) && (D = E, M = tf[E]);
        C = e.charCodeAt(z) === tw, C && (z++, x = T === hn ? Y7(E) : false, x && (D = E, M = x)), G = 1 + z - L, !C && !n || (E ? T === hn ? (C && !M ? k(df, 1) : (D !== E && (z = W + D.length, G = 1 + z - W, C = false), C || (B = D ? sf : cf, t.attribute ? (A = e.charCodeAt(z), A === nw ? (k(B, G), M = null) : lf(A) ? M = null : k(B, G)) : k(B, G))), R = M) : (C || k(uf, G), R = parseInt(E, Ns[T]), cw(R) ? (k(ff, G), R = fn(lw)) : R in rf ? (k($s, G), R = rf[R]) : ($ = "", pw(R) && k($s, G), R > 65535 && (R -= 65536, $ += fn(R >>> 10 | 55296), R = 56320 | R & 1023), R = $ + fn(R))) : T !== hn && k(pf, G)), R ? (ve(), U = K(), v = z - 1, m += z - L + 1, w.push(R), N = K(), N.offset++, i && i.call(
          c,
          R,
          { start: U, end: N },
          e.slice(L - 1, z)
  ...
  var gf = function(e) {
    var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, r = 0, n = {}, o = {
        ...
        DFS: a(function m(g7, y, w, D) {
          ...
          for (var C in g7)
            if (g7.hasOwnProperty(C)) {
              ...
              var E = g7[C], S = o.util.type(E);
              S === "Object" && !D[x(E)] ? (D[x(E)] = true, m(E, y, null, D)) : S === "Array" && !D[x(E)] && (D[x(E)] = true, m(E, y, C, D));
            }
        }, "DFS")
      },
      plugins: {},
      ...
      highlightElement: a(function(m, g7, y) {
        ...
        if (a(S, "insertHighlightedCode"), o.hooks.run("before-sanity-check", E), x = E.element.parentElement, x && x.nodeName.toLowerCase() === "pre" && !x.hasAttribute("tabindex") && x.setAttribute("tabindex", "0"), !E.code) {
      ...
      for (var C in y)
        if (!(!y.hasOwnProperty(C) || !y[C])) {
          ...
          for (var S = 0; S < E.length; ++S) {
            ...
            for (var W = R.pattern || R, L = w.next, T = D; L !== g7.tail && !(x && T >= x.reach); T += L.value.length, L = L.next) {
              var P = L.value;
              ...
              if (!(P instanceof i)) {
                ...
                if (L = p(g7, Ie, Yo), xe && p(g7, L, xe), U > 1) {
                  ...
                  u(m, g7, y, L.prev, T, Ko), x && Ko.reach > x.reach && (x.reach = Ko.reach);
                }
              }
            }
          }
...
var su = F(() => {
  ...
  lu = a(({ actionItems: e, ...t }) => import_react3.default.createElement(Tw, { ...t }, e.map(({
    ...
    onClick: o,
    disabled: i
  }, l) => import_react3.default.createElement(Ah, { key: l, className: n, onClick: o, disabled: !!i }, r))), "ActionBar");
});
function Bw(e, t) {
...
var pu = F(() => {
  ...
  ia = be2.forwardRef((e, t) => {
    ...
    if (i) {
      let l = i.props.children, u = o.map((c) => c === i ? be2.Children.count(l) > 1 ? be2.Children.only(null) : be2.isValidElement(l) ? l.props.children : null : c);
      return (0, import_jsx_runtime.jsx)(cu, { ...n, ref: t, children: be2.isValidElement(l) ? be2.cloneElement(l, void 0, u) : null });
    }
...
function Hh(e, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    function p(h) {
      let { scope: f, children: v, ...b } = h, m = (f == null ? void 0 : f[e][c]) || u, g7 = Tt.useMemo(() => b, Object.values(b));
      return (0, import_jsx_runtime3.jsx)(m.Provider, { value: g7, children: v });
    }
    a(p, "Provider");
    function d(h, f) {
      let v = (f == null ? void 0 : f[e][c]) || u, b = Tt.useContext(v);
      if (b) return b;
...
function lb(e, t, r, n = "ltr") {
  let o = xi(r), i = o / 2, l = t || i, u = o - l, c = r.scrollbar.paddingStart + l, p = r.scrollbar.size - r.scrollbar.paddingEnd - u, d = r.content - r.viewport, h = n === "ltr" ? [0, d] : [d * -1, 0];
  return o5([c, p], h)(e);
}
function Wh(e, t, r = "ltr") {
  let n = xi(t), o = t.scrollbar.paddingStart + t.scrollbar.paddingEnd, i = t.scrollbar.size - o, l = t.content - t.viewport, u = i - n, c = r === "ltr" ? [0, l] : [l * -1, 0], p = jh(e, c);
  return o5([0, l], [0, u])(p);
}
function o5(e, t) {
  return (r) => {
  ...
  hu = "ScrollArea", [Gh, fO] = Hh(hu), [Qw, Xe] = Gh(hu), Xh = I.forwardRef(
    (e, t) => {
      let {
        ...
        null
      ), [y, w] = I.useState(0), [D, x] = I.useState(0), [C, E] = I.useState(false), [S, R] = I.useState(false), A = Lt(t, (B) => c(B)), k = Oh(
        o
      );
...
`
  ...
  gt = "ScrollAreaScrollbar", Zh = I.forwardRef(
    (e, t) => {
      let { forceMount: r, ...n } = e, o = Xe(gt, e.__scopeScrollArea), { onScrollbarXEnabledChange: i, onScrollbarYEnabledChange: l } = o, u = e.orientation === "horizontal";
      return I.useEffect(() => (u ? i(true) : l(true), () => {
        u ? i(false) : l(false);
      }), [u, i, l]), o.type === "hover" ? (0, import_jsx_runtime5.jsx)(eb, { ...n, ref: t, forceMount: r }) : o.type === "scroll" ? (0, import_jsx_runtime5.jsx)(
        tb,
  ...
  Zh.displayName = gt;
  eb = I.forwardRef((e, t) => {
    let { forceMount: r, ...n } = e, o = Xe(gt, e.__scopeScrollArea), [i, l] = I.useState(false);
    return I.useEffect(() => {
    ...
    let { forceMount: r, ...n } = e, o = Xe(gt, e.__scopeScrollArea), i = e.orientation === "horizontal", l = Ci(() => c("SCROLL_END"), 100), [u, c] = Kw("hidden", {
      hidden: {
        SCROLL: "scrolling"
      },
      scrolling: {
    ...
    }, [o.viewport, i, c, l]), (0, import_jsx_runtime5.jsx)(gn, { present: r || u !== "hidden", children: (0, import_jsx_runtime5.jsx)(
      mu,
      {
    ...
    let r = Xe(gt, e.__scopeScrollArea), { forceMount: n, ...o } = e, [i, l] = I.useState(false), u = e.orientation === "horizontal", c = Ci(() => {
      if (r.viewport) {
    ...
    let { sizes: r, onSizesChange: n, ...o } = e, i = Xe(gt, e.__scopeScrollArea), [l, u] = I.useState(), c = I.useRef(null), p = Lt(t, c, i.onScrollbarXChange);
    return I.useEffect(() => {
    ...
    let { sizes: r, onSizesChange: n, ...o } = e, i = Xe(gt, e.__scopeScrollArea), [l, u] = I.useState(), c = I.useRef(null), p = Lt(t, c, i.onScrollbarYChange);
    return I.useEffect(() => {
      c.current && u(getComputedStyle(c.current));
    }, [c]), (0, import_jsx_runtime5.jsx)(
      e5,
    ...
    let {
      ...
      onResize: h,
      ...f
    } = e, v = Xe(gt, r), [b, m] = I.useState(null), g7 = Lt(t, (A) => m(A)), y = I.useRef(null), w = I.useRef(""), D = v.viewport, x = n.content - n.viewport, C = Jt(d), E = Jt(c), S = Ci(h, 10);
    function R(A) {
      if (y.current) {
    ...
    }, [D, b, x, C]), I.useEffect(E, [n, E]), wn(b, S), wn(v.content, S), (0, import_jsx_runtime5.jsx)(
      ob,
      {
        scope: r,
        scrollbar: b,
        ...
        children: (0, import_jsx_runtime5.jsx)(
          mn.div,
          {
            ...
            onPointerDown: Qt(e.onPointerDown, (A) => {
              A.button === 0 && (A.target.setPointerCapture(A.pointerId), y.current = b.getBoundingClientRect(), w.current = document.body.style.webkitUserSelect, document.body.style.webkitUserSelect = "none", v.viewport && (v.viewport.style.scrollBehavior = "auto"), R(A));
            }),
            onPointerMove: Qt(e.onPointerMove, R),
            onPointerUp: Qt(e.onPointerUp, (A) => {
              let k = A.target;
              k.hasPointerCapture(A.pointerId) && k.releasePointerCapture(A.pointerId), document.body.style.webkitUserSelect = w.current, v.viewport && (v.viewport.style.scrollBehavior = ""), y.current = null;
            })
          }
        )
      }
...
var Si = F(() => {
  ...
  db = Tr(i5)(
    ...
    ({ children: e, horizontal: t = false, vertical: r = false, offset: n = 2, scrollbarSize: o = 6, className: i }, l) => import_react4.default.createElement(
      ...
      import_react4.default.createElement(fb, { ref: l }, e),
    ...
    let [f, v] = (0, import_react5.useState)(false), b = (0, import_react5.useCallback)(
      (g7) => {
        g7.preventDefault(), bb(d).then(() => {
          v(true), vb.setTimeout(() => v(false), 1500);
...
function nE(e) {
  ...
  a(h, "f");
  function f() {
    let v = false, b, m, g7, y, w = {}, D, x, C, E, S;
    for (y = 0; y < n.length; y++) D = n[y], x = D[D.length - 1], C = D.substring(0, D.length - 1), E = parseInt(C, 10), S = parseFloat(C), A5.test(C) && x === "w" ? ((b || m) && (v = true), E === 0 ? v = true : b = E) : rE.test(C) && x === "x" ? ((b || m || g7) && (v = true), S < 0 ? v = true : m = S) : A5.test(C) && x === "h" ? ((g7 || m) && (v = true), E === 0 ? v = true : g7 = E) : v = true;
...
function lE(e) {
  ...
  let [n] = r, o = Em[n], i = t.map((d) => d.source.value), l = Math.max(...i.map((d) => d.length)), u = t.map((d) => d[n] ? String(d[n].value) : ""), c = u.map((d) => {
    let h = d.indexOf(".");
...
async function hE(e, t, r, n) {
  ...
  return [ue(await at(`function _(${i}) {}`, e, { parser: c ? "babel-ts" : "babel", __isVueForBindingLeft: true })), " ", l, " ", await at(
    u,
    e,
...
function mE(e) {
  ...
  let l = Oe(false, o[1].trim(), n, ""), u = l.match(r);
...
function DE(e) {
  return async (t, r, n, o) => {
    ...
    if (i) return i = pc(i, (l) => typeof l == "string" ? Oe(false, l, '"', "&quot;") : l), [n.node.rawName, '="', ue(i), '"'];
  };
}
function CE(e) {
...
function AE(e, t, r) {
  ...
  let i = ((n = o.prev) == null ? void 0 : n.type) === "comment" && RE(o.prev.value), l = typeof i == "boolean" ? () => i : Array.isArray(i) ? (h) => i.includes(h.rawName) : () => false, u = e.map(({ node: h }) => l(h) ? ot(t.originalText.slice(Ji(h), Qi(h))) : r(), "attrs"), c = o.type === "element" && o.fullName === "script" && o.attrs.length === 1 && o.attrs[0].fullName === "src" && o.children.length === 0, p = t.singleAttributePerLine && o.attrs.length > 1 && !to(o, t) ? Q : fe, d = [bt([c ? " " : fe, Qn(p, u)])];
    ...
    case "element":
      ...
      if (!r.isSelfClosing && fc(r, t)) {
        ...
        return n ? async (o, i) => {
          ...
          return u || (c = await o(um(l), { parser: n, __embeddedInHtml: true }), u = c === ""), [Mr(r, t), ue(Qu(e, t, i)), u ? "" : Q, c, u ? "" : Q, Ju(r, t), Ir(r, t)];
        } : void 0;
      }
      break;
    case "text":
...
function yc(e, t, r) {
  ...
  return e.map((i, l) => {
    ...
    return f && (Fi(u.prev) ? c.push(Q, Q) : f === Q ? c.push(Q) : Ye(u.prev) ? p.push(f) : p.push(Mi("", Ce, { groupId: o[l - 1] }))), v && (Fi(u) ? Ye(u.next) && h.push(Q, Q) : v === Q ? Ye(u.next) && h.push(Q) : d.push(v)), [
      ...c,
      ue([...p, ue([fa(i, t, r), ...d], { id: o[l] })]),
      ...h
    ];
  }, "children");
}
...
function aS(e) {
  ...
  e.walk((r) => {
    if (r.children) for (let n = 0; n < r.children.length; n++) {
      ...
      i.value += `<${o.rawName}>` + o.firstChild.value + `</${o.rawName}>` + l.value, i.sourceSpan = new j(i.sourceSpan.start, l.sourceSpan.end), i.isTrailingSpaceSensitive = l.isTrailingSpaceSensitive, i.hasTrailingSpaces = l.hasTrailingSpaces, r.removeChild(o), n--, r.removeChild(
        l
      );
    }
  });
  ...
  e.walk((n) => {
    if (xC(n)) for (let o of n.children) {
      ...
      for (let c = 0; c < u.length; c++, i = l) {
        ...
        l = i.moveBy(p.length + 4), n.insertChildBefore(o, { type: "interpolation", sourceSpan: new j(i, l), children: p.length === 0 ? [] : [{ type: "text", value: p, sourceSpan: new j(i.moveBy(2), l.moveBy(-2)) }] });
      }
      n.removeChild(o);
    }
  });
...
function lS(e) {
  e.walk((t) => {
    ...
    if (!r) for (let o = 0; o < t.children.length; o++) {
      ...
      u ? (i.value = u, i.sourceSpan = new j(i.sourceSpan.start.moveBy(l.length), i.sourceSpan.end.moveBy(-c.length)), l && (p && (p.hasTrailingSpaces = true), i.hasLeadingSpaces = true), c && (i.hasTrailingSpaces = true, d && (d.hasLeadingSpaces = true))) : (t.removeChild(i), o--, (l || c) && (p && (p.hasTrailingSpaces = true), d && (d.hasLeadingSpaces = true)));
    }
...
function dR(e, t, r) {
  let [, n, o, i] = r, l = 4 + n.length, u = e.sourceSpan.start.moveBy(l), c = u.moveBy(i.length), [p, d] = (() => {
    try {
      ...
      return [false, [{ type: "text", value: i, sourceSpan: new j(u, c) }]];
    }
  })();
...
function zm(e, t, r) {
  ...
  } = t, { rootNodes: d, errors: h } = K5(e, {
    canSelfClose: o,
    allowHtmComponentClosingTags: u,
    isTagNameCaseSensitive: c,
    getTagContentType: p ? (...w) => p(...w) ? nt.RAW_TEXT : void 0 : void 0,
    tokenizeAngularBlocks: n === "angular" ? true : void 0,
    tokenizeAngularLetDeclaration: n === "angular" ? true : void 0
  });
  if (n === "vue") {
    if (d.some((C) => C.type === "docType" && C.value === "html" || C.type === "element" && C.name.toLowerCase() === "html")) return zm(
      e,
      Nm,
      r
    );
    let w, D = a(() => w ?? (w = K5(e, { canSelfClose: o, allowHtmComponentClosingTags: u, isTagNameCaseSensitive: c })), "y"), x = a(
  ...
  let f = a((w) => {
    ...
    if (w.type === "element" && (i && (!w.namespace || w.namespace === w.tagDefinition.implicitNamespacePrefix || ya(w)) && (w.name = b(
      w.name,
      (D) => mR.has(D)
    )), l)) for (let D of w.attrs) D.namespace || (D.name = b(D.name, (x) => Zu.has(w.name) && (Zu.get("*").has(x) || Zu.get(
      w.name
    ).has(x))));
  }, "D"), g7 = a((w) => {
...
function Om(e, t, r = {}, n = true) {
  let { frontMatter: o, content: i } = n ? lR(e) : { frontMatter: null, content: e }, l = new Im(e, r.filepath), u = new ec(l, 0, 0, 0), c = u.moveBy(e.length), p = { type: "root", sourceSpan: new j(u, c), children: zm(i, t, r) };
  if (o) {
    let f = new ec(l, 0, 0, 0), v = f.moveBy(o.raw.length);
    o.sourceSpan = new j(f, v), p.children.unshift(o);
  }
  let d = new sR(p), h = a((f, v) => {
    let { offset: b } = v, m = Oe(false, e.slice(0, b), /[^\n\r]/gu, " "), g7 = Om(m + f, t, r, false);
    g7.sourceSpan = new j(v, Ca(false, g7.children, -1).sourceSpan.end);
    let y = g7.children[0];
...
`);
    ...
    _consumeTagOpen(t) {
      ...
      this._handleFullNameStackForTagOpen(n, r), l === nt.RAW_TEXT ? this._consumeRawTextWithTagClose(n, r, false) : l === nt.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, true);
    }
  ...
  $m = (rr = class {
    ...
    parse(t, r, n, o = false, i) {
      let l = a((b) => (m, ...g7) => b(m.toLowerCase(), ...g7), "a"), u = o ? this.getTagDefinition : l(this.getTagDefinition), c = a((b) => u(b).getContentType(), "u"), p = o ? i : l(i), d = NS(t, r, i ? (b, m, g7, y) => {
        let w = p(b, m, g7, y);
        return w !== void 0 ? w : c(b);
      } : c, n), h = n && n.canSelfClose || false, f = n && n.allowHtmComponentClosingTags || false, v = new eR(d.tokens, u, h, f, o);
    ...
    _parseExpansionCase() {
      ...
      let l = new j(t.sourceSpan.start, o.sourceSpan.end, t.sourceSpan.fullStart), u = new j(r.sourceSpan.start, o.sourceSpan.end, r.sourceSpan.fullStart);
...
`) {
    ...
    _consumeStartTag(t) {
      ...
      if (this._peek.type === 2) {
        ...
        this.canSelfClose || v.canSelfClose || Ii(i) !== null || v.isVoid || this.errors.push(Ae.create(i, t.sourceSpan, `Only void, custom and foreign elements can be self closed "${t.parts[1]}"`));
      } else this._peek.type === 1 && (this._advance(), l = false);
      let u = this._peek.sourceSpan.fullStart, c = new j(t.sourceSpan.start, u, t.sourceSpan.fullStart), p = new j(t.sourceSpan.start, u, t.sourceSpan.fullStart), d = new j(t.sourceSpan.start.moveBy(1), t.sourceSpan.end), h = new tr(i, o, [], c, p, void 0, d), f = this._getContainer();
      this._pushContainer(h, f instanceof tr && this.getTagDefinition(f.name).isClosedByChild(h.name)), l ? this._popContainer(i, tr, c) : t.type === 4 && (this._popContainer(i, tr, null), this.errors.push(Ae.create(i, c, `Opening tag "${i}" not terminated.`)));
    }
    _pushContainer(t, r) {
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if (Ii(l.name) ? l.name === t : (t == null || l.name.toLowerCase() === t.toLowerCase()) && l instanceof r) return l.endSourceSpan = n, l.sourceSpan.end = n !== null ? n.end : l.sourceSpan.end, this._containerStack.splice(i, this._containerStack.length - i), !o;
        (l instanceof yn || l instanceof tr && !this.getTagDefinition(l.name).closedByParent) && (o = true);
      }
      return false;
    }
    _consumeAttr(t) {
      ...
      let p = u && c && new j((o == null ? void 0 : o.sourceSpan.start) ?? u.start, c, (o == null ? void 0 : o.sourceSpan.fullStart) ?? u.fullStart);
    ...
    _consumeBlockOpen(t) {
      ...
      let n = this._peek.sourceSpan.fullStart, o = new j(t.sourceSpan.start, n, t.sourceSpan.fullStart), i = new j(t.sourceSpan.start, n, t.sourceSpan.fullStart), l = new yn(t.parts[0], r, [], o, t.sourceSpan, i);
    ...
    _consumeIncompleteBlock(t) {
      ...
      let n = this._peek.sourceSpan.fullStart, o = new j(t.sourceSpan.start, n, t.sourceSpan.fullStart), i = new j(t.sourceSpan.start, n, t.sourceSpan.fullStart), l = new yn(t.parts[0], r, [], o, t.sourceSpan, i);
      this._pushContainer(l, false), this._popContainer(null, yn, null), this.errors.push(Ae.create(t.parts[0], o, `Incomplete block "${t.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
    }
    _consumeLet(t) {
      let r = t.parts[0], n, o;
      ...
      let i = o.sourceSpan.fullStart, l = new j(t.sourceSpan.start, i, t.sourceSpan.fullStart), u = t.sourceSpan.toString().lastIndexOf(r), c = t.sourceSpan.start.moveBy(u), p = new j(c, t.sourceSpan.end), d = new j5(r, n.parts[0], l, p, n.sourceSpan);
      this._addToParent(d);
    }
    _consumeIncompleteLet(t) {
      let r = t.parts[0] ?? "", n = r ? ` "${r}"` : "";
      if (r.length > 0) {
        let o = t.sourceSpan.toString().lastIndexOf(r), i = t.sourceSpan.start.moveBy(o), l = new j(i, t.sourceSpan.end), u = new j(t.sourceSpan.start, t.sourceSpan.start.moveBy(0)), c = new j5(r, "", t.sourceSpan, l, u);
        this._addToParent(c);
      }
...
function iA(e) {
  ...
  function n(i, l, u) {
    ...
    if (i.type === ye) {
      let d = ((c = u == null ? void 0 : u[l + 1]) == null ? void 0 : c.type) === Ke;
    ...
    if (i.type === Ke) return ((p = u == null ? void 0 : u[l - 1]) == null ? void 0 : p.type) === ye && u[l - 1].hard ? void 0 : "breakParent";
  ...
  for (; r >= 0; ) {
    ...
    switch (h) {
      ...
      case He: {
        ...
        let f = d.break ? Pe : p, v = d.expandedStates && f === Pe ? he(false, d.expandedStates, -1) : d.contents;
        u.push({ mode: f, doc: v });
        break;
      }
      case Ne: {
...
function gl(e, t) {
  let r = {}, n = t.printWidth, o = Nc(t.endOfLine), i = 0, l = [{ ind: H22(), mode: Pe, doc: e }], u = [], c = false, p = [], d = 0;
  for (gA(e); l.length > 0; ) {
      ...
      case He:
        switch (v) {
          ...
          case Pe: {
            ...
            if (!b.break && ol(m, l, g7, y, r)) l.push(m);
            else if (b.expandedStates) {
              let w = he(false, b.expandedStates, -1);
              if (b.break) {
        ...
        b.id && (r[b.id] = he(false, l, -1).mode);
        break;
      case xt: {
        let m = n - i, { parts: g7 } = b;
        if (g7.length === 0) break;
        let [y, w] = g7, D = { ind: f, mode: yt, doc: y }, x = { ind: f, mode: Pe, doc: y }, C = ol(D, [], m, p.length > 0, r, true);
        if (g7.length === 1) {
          C ? l.push(D) : l.push(x);
          break;
        }
        ...
        g7.splice(0, 2);
        let R = { ind: f, mode: v, doc: k2(g7) }, A = g7[0];
        ol({ ind: f, mode: yt, doc: [y, w, A] }, [], m, p.length > 0, r, true) ? l.push(R, E, D) : C ? l.push(R, S, D) : l.push(R, S, x);
        break;
      }
      case Ne:
      case zt: {
      ...
      case ye:
        switch (v) {
          ...
          case Pe:
            ...
            b.literal ? f.root ? (u.push(o, f.root.value), i = f.root.length) : (u.push(o), i = 0) : (i -= Mc(u), u.push(o + f.value), i = f.length);
            break;
        }
        break;
      case Ct:
...
function Yc(e, t) {
  ...
  if (!n) return [];
  let u = ((r == null ? void 0 : r(e, t)) ?? [...z2(e, { getVisitorKeys: vl(o) })]).flatMap((c) => n(c) ? [c] : Yc(c, t));
...
function OA(e, t) {
  ...
  let n = [], { locStart: o, locEnd: i, printer: { experimentalFeatures: { avoidAstMutation: l = false } = {}, handleComments: u = {} }, originalText: c } = t, { ownLine: p = Sc, endOfLine: d = Sc, remaining: h = Sc } = u, f = r.map((v, b) => ({
    ...V2(e, v, t),
    comment: v,
    text: c,
    options: t,
  ...
  for (let [v, b] of f.entries()) {
    ...
    let S;
    if (l ? S = [b] : (m.enclosingNode = y, m.precedingNode = g7, m.followingNode = w, S = [m, D, x, C, E]), NA(D, x, f, v)) m.placement = "ownLine", p(...S) || (w ? no(w, m) : g7 ? oo(g7, m) : Hr(y || C, m));
    else if (jA(D, x, f, v)) m.placement = "endOfLine", d(...S) || (g7 ? oo(g7, m) : w ? no(w, m) : Hr(y || C, m));
    else if (m.placement = "remaining", !h(...S)) if (g7 && w) {
      let R = n.length;
      R > 0 && n[R - 1].followingNode !== w && Ym(n, x), n.push(b);
    } else g7 ? oo(g7, m) : w ? no(w, m) : Hr(y || C, m);
  }
...
function qA(e, t) {
  ...
  if ((r = i.isBlockComment) != null && r.call(i, n)) {
    let d = ar(l, c(n)) ? ar(l, u(n), { backwards: true }) ? zr : T2 : " ";
    o.push(d);
  } else o.push(zr);
  let p = Or(l, ir(l, c(n)));
  return p !== false && ar(l, p) && o.push(zr), o;
}
function WA(e, t, r) {
  var n;
...
function iF(e, t) {
  ...
  for (; h < o; ) for (l = t.charCodeAt(i + h), c = h++, u = h, d = 0; d < n; d++) p = l === r2[d] ? c : c + 1, c = Ac[d], u = Ac[d] = c > u ? p > u ? u + 1 : p : p > c ? c + 1 : p;
  return u;
}
function sF(e, t) {
...
function LF(e, t, { logger: r = false, isCLI: n = false, passThrough: o = false, FlagSchema: i, descriptor: l } = {}) {
  if (n) {
  ...
  let u = o ? Array.isArray(o) ? (f, v) => o.includes(f) ? { [f]: v } : void 0 : (f, v) => ({ [f]: v }) : (f, v, b) => {
    ...
    return Z2(f, v, { ...b, schemas: g7 });
  }, c = TF(t, { isCLI: n, FlagSchema: i }), p = new kF(c, { logger: r, unknown: u, descriptor: l }), d = r !== false;
...
function IF(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
  ...
  if (e.exception ? i.validate = (c, p, d) => e.exception(c) || p.validate(c, d) : i.validate = (c, p, d) => c === void 0 || p.validate(c, d), e.redirect && (u.redirect = (c) => c ? { to: typeof e.redirect == "string" ? e.redirect : { key: e.redirect.option, value: e.redirect.value } } : void 0), e.deprecated && (u.deprecated = true), t && !e.array) {
    ...
    i.preprocess = (p, d, h) => d.preprocess(c(Array.isArray(p) ? he(false, p, -1) : p), h);
  }
  return e.array ? dF.create({ ...t ? { preprocess: a((c) => Array.isArray(c) ? c : [c], "preprocess") } : {}, ...u, valueSchema: l.create(i) }) : l.create({ ...i, ...u });
}
function eg(e, t) {
...
async function HF(e, t = {}) {
  ...
  let o = G2({ plugins: e.plugins, showDeprecated: true }).options, i = { ...c2, ...Object.fromEntries(o.filter((f) => f.default !== void 0).map(
    (f) => [f.name, f.default]
  )) }, l = eg(n.plugins, n.parser), u = await rg(l, n.parser);
...
async function jF(e, t, r, n) {
  let o = await Eo({ ...r, ...t, parentParser: r.parser, originalText: e }, { passThrough: true }), { ast: i } = await Ia(e, o), l = await n(
    i,
    o
  );
  return _2(l);
...
function p2(e, t, r, n, o) {
  ...
  return (i = u.hasPrettierIgnore) != null && i.call(u, e) ? c = qF(e, t) : o.has(l) ? c = o.get(l) : c = u.print(e, t, r, n), l === t.cursorNode && (c = P2(c, (p) => [Ic, p, Ic])), u.printComment && (!u.willPrintOwnComments || !u.willPrintOwnComments(e, t)) && (c = GA(e, c, t)), c;
}
...
function WF(e, t) {
  let { cursorOffset: r, locStart: n, locEnd: o } = t, i = vl(t.printer.getVisitorKeys), l = a(
    (c) => n(c) <= r && o(c) >= r,
    "i"
  ), u = e;
...
`, o) + 1), c = n.slice(u, o).match(/^\s*/u)[0], p = Gc(c, t.tabWidth), d = await ig(l, {
    ...t,
    rangeStart: 0,
...
function lg(e, t) {
  ...
  if (l && (e = e.slice(1), r--, n--, o--), i === "auto" && (i = VR(e)), e.includes("\r")) {
    let u = a((c) => S2(e.slice(0, Math.max(c, 0)), `\r
`), "s");
...
function Fk(e, t, r) {
  let n = t === '"' ? "'" : '"', o = fl(false, e, /\\(.)|(["'])/gsu, (i, l, u) => l === n ? l : u === t ? "\\" + u : u || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(l) ? l : "\\" + l));
  return t + o + t;
}
function Lk(e, t, r) {
  return Qc(e, r(t));
...
var hg = F(() => {
  ...
  MR = LR(() => {
    ...
    var h = /\r\n|[\n\r\u2028\u2029]/;
    function f(m, g7, y) {
      let w = Object.assign({ column: 0, line: -1 }, m.start), D = Object.assign({}, w, m.end), { linesAbove: x = 2, linesBelow: C = 3 } = y || {}, E = w.line, S = w.column, R = D.line, A = D.column, k = Math.max(E - (x + 1), 0), B = Math.min(g7.length, R + C);
      E === -1 && (k = 0), R === -1 && (B = g7.length);
      let $ = R - E, M = {};
      if ($) for (let W = 0; W <= $; W++) {
        let L = W + E;
        if (!S) M[L] = true;
      ...
      else S === A ? S ? M[E] = [S, 0] : M[E] = true : M[E] = [S, A - S];
      return { start: k, end: B, markerLines: M };
    }
    a(f, "No");
    function v(m, g7, y = {}) {
      let w = (y.highlightCode || y.forceColor) && (0, t.shouldHighlight)(y), D = c(y.forceColor), x = d(D), C = a((M, W) => w ? M(W) : W, "i"), E = m.split(h), { start: S, end: R, markerLines: A } = f(g7, E, y), k = g7.start && typeof g7.start.column == "number", B = String(
        R
      ).length, $ = (w ? (0, t.default)(m, y) : m).split(h, R).slice(S, R).map((M, W) => {
    ...
    function y() {
      for (var D = Math.max(m, -p); D <= Math.min(g7, p); D += 2) {
        ...
        if (!A || S && C.oldPos + 1 < E.oldPos ? x = i.addToPath(E, true, void 0, 0) : x = i.addToPath(C, void 0, true, 1), b = i.extractCommon(
          ...
          e,
          D
        ), x.oldPos + 1 >= c && b + 1 >= u) return l($R(i, x.lastComponent, t, e, i.useLongestToken));
...
`));
  ...
  a(tA, "wr");
  a(Tc, "xe");
  rA = { type: Nt }, hl = { type: Ke }, nA = { type: $t }, qc = { type: ye, hard: true }, L2 = { type: ye, hard: true, literal: true }, T2 = { type: ye }, oA = { type: ye, soft: true }, zr = [qc, hl], I2 = [L2, hl], Ic = { type: jr };
  a(B2, "be");
  a(M2, "Je");
  a(aA, "br");
  a(Bt, "ee");
...
in order for it to be formatted.`,
  ...
  nF = rF, ao = { key: a((e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), "key"), value(e) {
    ...
    return n && i.push(e2(e, t, n, r.descriptor)), o && i.push([e2(e, t, o.title, r.descriptor)].concat(o.values.map((l) => Y2(l, r.loggerPrintWidth))).join(`
`)), K2(i, r.loggerPrintWidth);
  ...
  Z2 = a((e, t, { descriptor: r, logger: n, schemas: o }) => {
    let i = [`Ignored unknown option ${t2.default.yellow(r.pair({ key: e, value: t }))}.`], l = Object.keys(o).sort().find((u) => iF(e, u) < 3);
  ...
  xF = (vo = class extends lr {
    ...
    constructor(t, r) {
      let { logger: n = console, loggerPrintWidth: o = 80, descriptor: i = SF, unknown: l = RF, invalid: u = AF, deprecated: c = FF, missing: p = a(
        () => false,
        "D"
      ...
      }, this._unknownHandler = l, this._invalidHandler = yF(u), this._deprecatedHandler = c, this._identifyMissing = (v, b) => !(v in b) || p(v, b), this._identifyRequired = d, this._preprocess = h, this._postprocess = f, this.cleanHistory();
    }
    cleanHistory() {
    ...
    _applyNormalization(t, r) {
      ...
      for (let l of o) {
        ...
        let p = a(({ from: f, to: v }) => {
          ...
          let b = i2(u.deprecated(f, this._utils), c, true);
...
function Qe(e, t, r) {
  ...
  var l = Je(e) ? ee(e) : window, u = l.visualViewport, c = !ja() && r, p = (n.left + (c && u ? u.offsetLeft : 0)) / o, d = (n.top + (c && u ? u.offsetTop : 0)) / i, h = n.width / o, f = n.height / i;
  return {
    width: h,
    height: f,
    top: d,
...
function lB(e) {
  ...
  if (!(!i || !l)) {
    var h = iB(o.padding, r), f = Zr(i), v = c === "y" ? ne : oe, b = c === "y" ? ce : se, m = r.rects.reference[d] + r.rects.reference[c] - l[c] - r.rects.popper[d], g7 = l[c] - r.rects.reference[c], y = pt(i), w = y ? c === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, D = m / 2 - g7 / 2, x = h[v], C = w - f[d] - h[b], E = w / 2 - f[d] / 2 + D, S = Qr(x, E, C), R = c;
...
function m3(e) {
  ...
  if (p) {
    ...
    if (E === ee(r) && (E = De(r), ke(E).position !== "static" && u === "absolute" && (S = "scrollHeight", R = "scrollWidth")), E = E, o === ne || (o === oe || o === se) && i === Yr) {
      x = ce;
...
function f1(e) {
  var t, r = De(e), n = en(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = ct(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), l = ct(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), u = -n.scrollLeft + tn(
    e
  ), c = -n.scrollTop;
...
function hr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Xl(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), i = ee(n), l = o ? [i].concat(i.visualViewport || [], rn(n) ? n : []) : n, u = t.concat(l);
  return o ? u : (
...
function Xa(e) {
  var t = e.reference, r = e.element, n = e.placement, o = n ? ge(n) : null, i = n ? et(n) : null, l = t.x + t.width / 2 - r.width / 2, u = t.y + t.height / 2 - r.height / 2, c;
  switch (o) {
    case ne:
      c = {
        x: l,
...
function dt(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, i = r.strategy, l = i === void 0 ? e.strategy : i, u = r.boundary, c = u === void 0 ? a3 : u, p = r.rootBoundary, d = p === void 0 ? zl : p, h = r.elementContext, f = h === void 0 ? _o : h, v = r.altBoundary, b = v === void 0 ? false : v, m = r.padding, g7 = m === void 0 ? 0 : m, y = Ua(typeof g7 != "number" ? g7 : Ga(g7, cr)), w = f === _o ? i3 : _o, D = e.rects.popper, x = e.elements[b ? w : f], C = g1(Je(x) ? x : x.contextElement || De(e.elements.popper), c, d, l), E = Qe(e.elements.reference), S = Xa(
    {
      reference: E,
      element: D,
      strategy: "absolute",
...
function w1(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, i = r.rootBoundary, l = r.padding, u = r.flipVariations, c = r.allowedAutoPlacements, p = c === void 0 ? Ol : c, d = et(n), h = d ? u ? n1 : n1.filter(function(b) {
    return et(b) === d;
...
function wB(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? true : o, l = r.altAxis, u = l === void 0 ? true : l, c = r.fallbackPlacements, p = r.padding, d = r.boundary, h = r.rootBoundary, f = r.altBoundary, v = r.flipVariations, b = v === void 0 ? true : v, m = r.allowedAutoPlacements, g7 = t.options.placement, y = ge(g7), w = y === g7, D = c || (w || !b ? [jo(g7)] : vB(g7)), x = [g7].concat(D).reduce(function(ve, de) {
    ...
    }, []), C = t.rects.reference, E = t.rects.popper, S = /* @__PURE__ */ new Map(), R = true, A = x[0], k = 0; k < x.length; k++) {
...
function CB(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, i = o === void 0 ? true : o, l = r.altAxis, u = l === void 0 ? false : l, c = r.boundary, p = r.rootBoundary, d = r.altBoundary, h = r.padding, f = r.tether, v = f === void 0 ? true : f, b = r.tetherOffset, m = b === void 0 ? 0 : b, g7 = dt(t, {
    boundary: c,
    rootBoundary: p,
    padding: h,
    altBoundary: d
  }), y = ge(t.placement), w = et(t.placement), D = !w, x = Jr(y), C = b1(x), E = t.modifiersData.popperOffsets, S = t.rects.reference, R = t.rects.popper, A = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, k = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (E) {
    if (i) {
      var M, W = x === "y" ? ne : oe, L = x === "y" ? ce : se, T = x === "y" ? "height" : "width", P = E[x], U = P + g7[W], N = P - g7[L], G = v ? -R[T] / 2 : 0, z = w === Vt ? S[T] : R[T], K = w === Vt ? -R[T] : -S[T], Le = t.elements.arrow, ve = v && Le ? Zr(Le) : {
        width: 0,
        height: 0
        ...
        S[T],
        ve[T]
      ), Yo = D ? S[T] / 2 - G - Ie - xe - k.mainAxis : z - Ie - xe - k.mainAxis, Ko = D ? -S[T] / 2 + G + Ie + Te + k.mainAxis : K + Ie + Te + k.mainAxis, as = t.elements.arrow && pt(t.elements.arrow), I4 = as ? x === "y" ? as.clientTop || 0 : as.clientLeft || 0 : 0, K1 = (M = B == null ? void 0 : B[x]) != null ? M : 0, B4 = P + Yo - K1 - I4, M4 = P + Ko - K1, Z1 = Qr(v ? Kr(U, B4) : U, P, v ? ct(N, M4) : N);
      E[x] = Z1, $[x] = Z1 - P;
    }
    if (u) {
      var J1, _4 = x === "x" ? ne : oe, P4 = x === "x" ? ce : se, wr = E[C], ei = C === "y" ? "height" : "width", Q1 = wr + g7[_4], ep = wr - g7[P4], is = [ne, oe].indexOf(y) !== -1, tp = (J1 = B == null ? void 0 : B[C]) != null ? J1 : 0, rp = is ? Q1 : wr - S[ei] - R[ei] - tp + k.altAxis, np = is ? wr + S[ei] + R[ei] - tp - k.altAxis : ep, op = v && is ? d3(rp, wr, np) : Qr(v ? rp : Q1, wr, v ? np : ep);
      E[C] = op, $[C] = op - wr;
    }
    t.modifiersData[n] = $;
  }
...
function C1(e, t, r) {
  ...
  rn(i)) && (u = x1(t)), pe(t) ? (c = Qe(t, true), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = tn(i))), {
...
function u4(e, t) {
  ...
  var i = Object.keys(i4).reduce(function(L, T) {
    var P;
    return H2({}, L, (P = {}, P[T] = L[T] !== void 0 ? L[T] : i4[T], P));
  }, e), l = X.useMemo(
    function() {
      return [{
        name: "offset",
  ...
  }, [i.delayHide, g7]), k = X.useCallback(function() {
    clearTimeout(y.current), y.current = window.setTimeout(function() {
      return g7(true);
    }, i.delayShow);
  }, [i.delayShow, g7]), B = X.useCallback(function() {
    S().visible ? A() : k();
  }, [S, A, k]);
  X.useEffect(function() {
    if (S().finalConfig.closeOnOutsideClick) {
      var L = a(function(P) {
        var U, N = S(), G = N.tooltipRef, z = N.triggerRef, K = (P.composedPath == null || (U = P.composedPath()) == null ? void 0 : U[0]) || P.target;
  ...
  X.useEffect(function() {
    ...
    function L(T) {
      ...
      a4.getBoundingClientRect = s4(P, U), E == null ? void 0 : E();
    }
  ...
  var M = a(function(T) {
    ...
    return T === void 0 && (T = {}), H2({}, T, x.arrow, {
...
var f4 = F(() => {
  ...
  d4 = we(ea(), 1), tt = (0, d4.default)(1e3)(
    ...
    ({
      ...
      withArrows: l,
      ...u
    }, c) => import_react6.default.createElement(PB, { "data-testid": "tooltip", hasChrome: t, ref: c, ...u, color: i }, t && l && import_react6.default.createElement(_B, { placement: e, ...n, color: i }), r)
  );
...
`, m4 = a(({
    ...
    ), $ = k ? import_react7.default.createElement(
      L1,
      {
    ...
    return import_react7.default.createElement(import_react7.default.Fragment, null, import_react7.default.createElement(C, { trigger: t, ref: A, ...x }, d), k && import_react_dom.default.createPortal($, Kl.body));
...
function fs(e) {
  ...
  var l = J4.exec(t);
  if (l) {
    var u = parseInt("" + l[1], 10), c = parseInt("" + l[2], 10) / 100, p = parseInt("" + l[3], 10) / 100, d = "rgb(" + Jo(u, c, p) + ")", h = us.exec(d);
    if (!h)
      throw new ht(4, t, d);
    return {
      red: parseInt("" + h[1], 10),
  ...
  if (f) {
    var v = parseInt("" + f[1], 10), b = parseInt("" + f[2], 10) / 100, m = parseInt("" + f[3], 10) / 100, g7 = "rgb(" + Jo(v, b, m) + ")", y = us.exec(g7);
    if (!y)
      throw new ht(4, t, g7);
    return {
      red: parseInt("" + y[1], 10),
...
var bu = a(({
  ...
  return o.filter(b5).some((l) => l.match(kb)) ? import_react11.default.createElement(
    Tb,
    {
      bordered: true,
      copyable: true,
...
function Eg(e, t) {
  ...
  function n(i) {
    let { children: l, ...u } = i, c = (0, import_react18.useMemo)(
      () => u,
      Object.values(u)
    );
  ...
  a(n, "Provider");
  function o(i) {
    let l = (0, import_react18.useContext)(r);
    if (l) return l;
...
function Sg(e, t = []) {
  let r = [];
  function n(i, l) {
    let u = (0, import_react18.createContext)(l), c = r.length;
    r = [
      ...r,
      l
    ];
    function p(h) {
      let { scope: f, children: v, ...b } = h, m = (f == null ? void 0 : f[e][c]) || u, g7 = (0, import_react18.useMemo)(
        () => b,
        Object.values(b)
      );
    ...
    a(p, "Provider");
    function d(h, f) {
      let v = (f == null ? void 0 : f[e][c]) || u, b = (0, import_react18.useContext)(v);
      if (b) return b;
      if (l !== void 0) return l;
      throw new Error(`\`${h}\` must be used within \`${i}\``);
    }
  ...
  let o = a(() => {
    let i = r.map((l) => (0, import_react18.createContext)(l));
    return a(function(u) {
      let c = (u == null ? void 0 : u[e]) || i;
...
function Rg({ prop: e, defaultProp: t, onChange: r = a(() => {
  ...
  let [n, o] = rL({
    defaultProp: t,
    onChange: r
  }), i = e !== void 0, l = i ? e : n, u = it(r), c = (0, import_react20.useCallback)((p) => {
    if (i) {
...
var o0 = (0, import_react24.forwardRef)((e, t) => {
  ...
  if (i) {
    let l = i.props.children, u = o.map((c) => c === i ? import_react24.Children.count(l) > 1 ? import_react24.Children.only(null) : (0, import_react24.isValidElement)(l) ? l.props.children : null : c);
    return (0, import_react24.createElement)(n0, H2({}, n, {
      ref: t
    }), (0, import_react24.isValidElement)(l) ? (0, import_react24.cloneElement)(l, void 0, u) : null);
  }
  return (0, import_react24.createElement)(n0, H2({}, n, {
    ref: t
  }), r);
...
var Ze = pL.reduce((e, t) => {
  let r = (0, import_react23.forwardRef)((n, o) => {
    ...
    }, []), (0, import_react23.createElement)(u, H2({}, l, {
      ref: o
    }));
  });
...
var Mg = (0, import_react22.forwardRef)((e, t) => {
  ...
  let {
    ...
    onDismiss: c,
    ...p
  } = e, d = (0, import_react22.useContext)(bL), [h, f] = (0, import_react22.useState)(null), v = (r = h == null ? void 0 : h.ownerDocument) !== null && r !== void 0 ? r : globalThis == null ? void 0 : globalThis.document, [, b] = (0, import_react22.useState)({}), m = St(
    t,
    (R) => f(R)
  ), g7 = Array.from(d.layers), [y] = [
    ...d.layersWithOutsidePointerEventsDisabled
  ].slice(-1), w = g7.indexOf(y), D = h ? g7.indexOf(h) : -1, x = d.layersWithOutsidePointerEventsDisabled.size > 0, C = D >= w, E = yL((R) => {
    let A = R.target, k = [
      ...d.branches
    ].some(
      (B) => B.contains(A)
    );
    !C || k || (i == null ? void 0 : i(R), u == null ? void 0 : u(R), R.defaultPrevented || (c == null ? void 0 : c()));
  }, v), S = DL((R) => {
    let A = R.target;
    [
      ...d.branches
  ...
  }, v), (0, import_react22.useEffect)(() => {
    if (h)
      return n && (d.layersWithOutsidePointerEventsDisabled.size === 0 && (Ig = v.body.style.pointerEvents, v.body.style.pointerEvents = "none"), d.layersWithOutsidePointerEventsDisabled.add(h)), d.layers.add(h), Bg(), () => {
...
var jg = (0, import_react26.forwardRef)((e, t) => {
  let { loop: r = false, trapped: n = false, onMountAutoFocus: o, onUnmountAutoFocus: i, ...l } = e, [u, c] = (0, import_react26.useState)(null), p = it(o), d = it(i), h = (0, import_react26.useRef)(
    null
  ), f = St(
    t,
    (m) => c(m)
  ), v = (0, import_react26.useRef)({
    paused: false,
    pause() {
      this.paused = true;
    },
    ...
    if (n) {
      let m = function(D) {
        ...
        if (document.activeElement === document.body)
          for (let C of D) C.removedNodes.length > 0 && sr2(u);
      };
      ...
      return u && w.observe(u, {
        ...
        document.removeEventListener("focusin", m), document.removeEventListener("focusout", g7), w.disconnect();
      };
    }
  }, [
    n,
    ...
    if (u) {
      ...
      return () => {
        u.removeEventListener(l0, p), setTimeout(() => {
          ...
          u.addEventListener(s0, d), u.dispatchEvent(y), y.defaultPrevented || sr2(m ?? document.body, {
            select: true
  ...
  let b = (0, import_react26.useCallback)((m) => {
    ...
    if (g7 && y) {
      ...
      D && x ? !m.shiftKey && y === x ? (m.preventDefault(), r && sr2(D, {
        select: true
      })) : m.shiftKey && y === D && (m.preventDefault(), r && sr2(x, {
        select: true
...
function VL(e) {
  let [t, r] = (0, import_react28.useState)(), n = (0, import_react28.useRef)({}), o = (0, import_react28.useRef)(e), i = (0, import_react28.useRef)("none"), l = e ? "mounted" : "unmounted", [u, c] = jL(l, {
    mounted: {
      UNMOUNT: "unmounted",
      ANIMATION_OUT: "unmountSuspended"
    },
...
var $a = Ee.forwardRef(function(e, t) {
  ...
  }), o = n[0], i = n[1], l = e.forwardProps, u = e.children, c = e.className, p = e.removeScrollBar, d = e.enabled, h = e.shards, f = e.sideCar, v = e.noIsolation, b = e.inert, m = e.allowPinchZoom, g7 = e.as, y = g7 === void 0 ? "div" : g7, w = El(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as"]), D = f, x = f0([r, t]), C = $e($e(
    {},
    w
  ), o);
...
var av = a(function(e, t, r, n, o) {
  var i = iT(e, window.getComputedStyle(t).direction), l = i * n, u = r.target, c = t.contains(u), p = false, d = l > 0, h = 0, f = 0;
  do {
    var v = ov(e, u), b = v[0], m = v[1], g7 = v[2], y = m - g7 - i * b;
...
function sv(e) {
  ...
  var u = J.useCallback(function(m, g7) {
    ...
    var y = Fl(m), w = r.current, D = "deltaX" in m ? m.deltaX : w[0] - y[0], x = "deltaY" in m ? m.deltaY : w[1] - y[1], C, E = m.target, S = Math.abs(D) > Math.abs(x) ? "h" : "v";
    ...
    if (!n.current && "changedTouches" in m && (D || x) && (n.current = C), !C)
      return true;
    var A = n.current || C;
    return av(A, g7, m, A === "h" ? D : x, true);
  }, []), c = J.useCallback(function(m) {
    var g7 = m;
    if (!(!Fo.length || Fo[Fo.length - 1] !== i)) {
      var y = "deltaY" in g7 ? iv(g7) : Fl(g7), w = t.current.filter(function(C) {
        return C.name === g7.type && C.target === g7.target && lT(C.delta, y);
      })[0];
      if (w && w.should) {
    ...
    var D = { name: m, delta: g7, target: y, should: w };
  ...
  var d = a(function(h) {
    !h || c.has(h) || Array.prototype.forEach.call(h.children, function(f) {
      if (u.has(f))
        ...
        var v = f.getAttribute(n), b = v !== null && v !== "false", m = (ko.get(f) || 0) + 1, g7 = (i.get(f) || 0) + 1;
        ko.set(f, m), i.set(f, g7), l.push(f), m === 1 && b && Ll.set(f, true), g7 === 1 && f.setAttribute(r, "true"), b || f.setAttribute(n, "true");
      }
    });
  }, "deep");
...
var F0 = (0, import_react31.forwardRef)((e, t) => {
  ...
  if (i) {
    let l = i.props.children, u = o.map((c) => c === i ? import_react31.Children.count(l) > 1 ? import_react31.Children.only(null) : (0, import_react31.isValidElement)(l) ? l.props.children : null : c);
    return (0, import_react31.createElement)(A0, H2({}, n, {
      ref: t
    }), (0, import_react31.isValidElement)(l) ? (0, import_react31.cloneElement)(l, void 0, u) : null);
  }
  return (0, import_react31.createElement)(A0, H2({}, n, {
    ref: t
  }), r);
...
var [xT, lt] = gv(mv);
var vv = a((e) => {
  let { __scopeDialog: t, children: r, open: n, defaultOpen: o, onOpenChange: i, modal: l = true } = e, u = (0, import_react16.useRef)(null), c = (0, import_react16.useRef)(null), [p = false, d] = Rg(
    {
      prop: n,
      defaultProp: o,
      onChange: i
...
var Dv = a((e) => {
  ...
  return (0, import_react16.createElement)(ET, {
    ...
    n,
    (l) => (0, import_react16.createElement)(Ha, {
      present: r || i.open
...
var AT = (0, import_react16.forwardRef)((e, t) => {
  ...
  return (0, import_react16.createElement)(Ev, H2({}, e, {
    ...
    onInteractOutside: a((i) => {
      var l, u;
      (l = e.onInteractOutside) === null || l === void 0 || l.call(e, i), i.defaultPrevented || (n.current = true, i.detail.originalEvent.type === "pointerdown" && (o.current = true));
      let c = i.target;
...
var Ev = (0, import_react16.forwardRef)((e, t) => {
  let { __scopeDialog: r, trapFocus: n, onOpenAutoFocus: o, onCloseAutoFocus: i, ...l } = e, u = lt(To, r), c = (0, import_react16.useRef)(null), p = St(t, c);
...
var Io = (0, import_react34.forwardRef)(
  ({
    ...
    let d = "button";
    c.isLink && (d = "a"), e && (d = ia);
    let h = n, f = r, [v, b] = (0, import_react34.useState)(false), m = a((g7) => {
...
function KT({
  ...
  return import_react15.default.createElement(T0, { ...u }, import_react15.default.createElement(I0, { container: l }, import_react15.default.createElement(
    B0,
    { asChild: true },
...
function cI(e, t) {
  ...
  }, []), (0, import_react38.useCallback)(function(l) {
    o.current = l, i();
  }, [i]);
}
...
function _l(e) {
  ...
  var n = e.round || Math.round, o = (0, import_react38.useRef)(), i = (0, import_react38.useState)({
    width: void 0,
    height: void 0
  }), l = i[0], u = i[1], c = (0, import_react38.useRef)(false);
  (0, import_react38.useEffect)(function() {
  ...
  var p = (0, import_react38.useRef)({
    width: void 0,
    height: void 0
  }), d = cI((0, import_react38.useCallback)(function(h) {
    return (!o.current || o.current.box !== e.box || o.current.round !== n) && (o.current = {
      box: e.box,
      round: n,
      instance: new ResizeObserver(function(f) {
        var v = f[0], b = e.box === "border-box" ? "borderBoxSize" : e.box === "device-pixel-content-box" ? "devicePixelContentBoxSize" : "contentBoxSize", m = Pv(v, b, "inlineSize"), g7 = Pv(v, b, "blockSize"), y = m ? n(m) : void 0, w = g7 ? n(g7) : void 0;
...
${t}`);
  ...
  return import_react40.default.createElement(import_react40.Fragment, null, import_react40.default.createElement("span", null, n), ": ", import_react40.default.createElement(
    ...
    null,
    o
  ), import_react40.default.createElement("br", null), l.map(
    (u, c) => (u == null ? void 0 : u.name) ? import_react40.default.createElement(import_react40.Fragment, { key: c }, "  ", "at ", import_react40.default.createElement(DI, null, u.name), " (", import_react40.default.createElement(Ov, null, u.location), ")", import_react40.default.createElement("br", null)) : import_react40.default.createElement(
      import_react40.Fragment,
      { key: c },
      "  ",
      "at ",
      import_react40.default.createElement(Ov, null, u == null ? void 0 : u.location),
...
var qI = a(function(t, r) {
  var n = t.cacheMeasurements, o = t.maxRows, i = t.minRows, l = t.onChange, u = l === void 0 ? Zv : l, c = t.onHeightChange, p = c === void 0 ? Zv : c, d = un(t, VI), h = d.value !== void 0, f = st.useRef(null), v = Gv(f, r), b = st.useRef(0), m = st.useRef(), g7 = a(
    function() {
...
var cM = a(({
  ...
  return import_react49.default.createElement(sM, { ...h, ...f, ...v }, import_react49.default.createElement(import_react49.default.Fragment, null, p && import_react49.default.createElement(lM, { ...f }, p), t || r ? import_react49.default.createElement(aM, { isIndented: !!(!p && l) }, t && import_react49.default.createElement(
    nM,
    { ...f, loading: e },
    t
...
var mM = a(({ id: e, onClick: t, ...r }) => {
  let { active: n, disabled: o, title: i, href: l } = r, u = (0, import_react48.useCallback)(
    (c) => t == null ? void 0 : t(c, { id: e, active: n, disabled: o, title: i, href: l }),
    [t, e, n, o, i, l]
  );
  return import_react48.default.createElement(B1, { id: `list-item-${e}`, ...r, ...t && { onClick: u } });
}, "Item");
var M1 = a(({ links: e, LinkWrapper: t, ...r }) => {
  let n = Array.isArray(e[0]) ? e : [e], o = n.some((i) => i.some((l) => "icon" in l && l.icon));
  return import_react48.default.createElement(fM, { ...r }, n.filter((i) => i.length).map((i, l) => import_react48.default.createElement(hM, { key: i.map((u) => u.id).join(`~${l}~`) }, i.map((u) => "content" in u ? import_react48.default.createElement(import_react48.Fragment, { key: u.id }, u.content) : import_react48.default.createElement(mM, { key: u.id, isIndented: o, LinkWrapper: t, ...u })))));
}, "TooltipLinkList");
Si();
var _1 = Tr.div(
  {
...
var D4 = a((e) => import_react54.Children.toArray(e).map(
  ...
  ({
    ...
    return {
      ...
      id: r,
      ...n ? { color: n } : {},
      render: typeof i == "function" ? i : ({ active: u }) => import_react54.default.createElement(O1, { active: u, role: "tabpanel" }, i)
    };
  }
), "childrenToList");
Zl();
...
function E4(e) {
  let t = (0, import_react55.useRef)(), r = (0, import_react55.useRef)(), n = (0, import_react55.useRef)(/* @__PURE__ */ new Map()), { width: o = 1 } = _l({
    // @ts-expect-error (non strict)
    ref: t
  }), [i, l] = (0, import_react55.useState)(e), [u, c] = (0, import_react55.useState)([]), p = (0, import_react55.useRef)(e), d = (0, import_react55.useCallback)(
    ({
      menuName: f,
      actions: v
    }) => {
      let b = u.some(({ active: y }) => y), [m, g7] = (0, import_react55.useState)(false);
    ...
    [u]
  ), h = (0, import_react55.useCallback)(() => {
    ...
    let { x: f, width: v } = t.current.getBoundingClientRect(), { width: b } = r.current.getBoundingClientRect(), m = u.length ? f + v - b : f + v, g7 = [], y = 0, w = e.filter((D) => {
      let { id: x } = D, C = n.current.get(x), { width: E = 0 } = (C == null ? void 0 : C.getBoundingClientRect()) || {}, S = f + y + E > m;
      return (!S || !C) && g7.push(D), y += E, S;
    });
    (g7.length !== i.length || p.current !== e) && (l(g7), c(w), p.current = e);
  }, [u.length, e, i]);
  return (0, import_react55.useLayoutEffect)(h, [h, o]), {
    tabRefs: n,
    addonsRef: r,
    tabBarRef: t,
    visibleList: i,
...
var W1 = (0, import_react50.memo)(
  ({
    ...
    let h = (0, import_react50.useMemo)(
      () => D4(e).map((y, w) => ({
        ...y,
        active: t ? y.id === t : w === 0
      })),
      [e, t]
    ), { visibleList: f, tabBarRef: v, tabRefs: b, AddonTab: m } = E4(h), g7 = p ?? import_react50.default.createElement(z1, { title: "Nothing found" });
    return !d && h.length === 0 ? g7 : (
      // @ts-expect-error (non strict)
      import_react50.default.createElement(VM, { absolute: n, bordered: o, id: u }, import_react50.default.createElement(Jl, {
        scrollable: false,
        border: true,
        backgroundColor: l
      }, import_react50.default.createElement(q1, { style: { whiteSpace: "normal" }, ref: v, role: "tablist" }, f.map(({
        title: y,
        id: w,
        active: D,
        color: x
      ...
      }), import_react50.default.createElement(m, { menuName: c, actions: r })), i), import_react50.default.createElement(qM, { id: "panel-tab-content", bordered: o, absolute: n }, h.length ? h.map(({ id: y, active: w, render: D }) => import_react50.default.createElement(D, { key: y, active: w }, null)) : g7))
    );
  }
);
W1.displayName = "Tabs";
...
var b_ = a(({ progress: e, error: t, size: r, ...n }) => {
  ...
  if (e) {
    ...
    return i && (l += ` ${i.complete} / ${i.total} modules`), import_react61.default.createElement(
      A4,
      {
      ...
      import_react61.default.createElement(F4, null, l, o < 1 && import_react61.default.createElement(w_, { key: l }))
    );
  }
...
//# sourceMappingURL=chunk-2S7I676J.js.map
